...
namespace Symbio\OrangeGate\NewsBundle\Controller;
...
{
    /**
     * @Route("/", name="orangegate_news_home")
     *
    ...
    /**
     * @Route("/archive", name="orangegate_news_archive")
     */
    ...
    /**
     * @Route("/archive/{year}", name="orangegate_news_archive_yearly")
     */
    ...
    /**
     * @Route("/archive/{year}/{month}", name="orangegate_news_archive_monthly")
     */
    ...
    /**
     * @Route("/c/{collection}", name="orangegate_news_collection")
     */
    ...
    /**
     * @Route("/{permalink}", name="orangegate_news_view", requirements={"permalink":".+?"})
     */
    ...
    public function commentsAction($postId)
    {
        ...
        return $this->render('SymbioOrangeGateNewsBundle:Post:comments.html.twig', array(
            'pager'  => $pager,
        ));
    }
    ...
    public function addCommentFormAction($postId, $form = false)
    {
        ...
        return $this->render('SymbioOrangeGateNewsBundle:Post:comment_form.html.twig', array(
    ...
    public function addCommentAction($id)
    {
        ...
        return $this->render('SymbioOrangeGateNewsBundle:Post:view.html.twig', array(
            'post' => $post,
            'form' => $form
        ));
    }
    ...
    {
        return $this->get('orangegate.news.manager.post');
    }
    ...
    {
        return $this->get('orangegate.news.permalink.generator');
    }
}
